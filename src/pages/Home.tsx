        ...
        <div className="flex-1 min-w-0">
          ...
          <section className="page-container mt-20 sm:mt-24">
            <div className="text-center mb-12 animate-slide-up">
              ...
              <p className="section-subheading mx-auto">{t('home.categoriesDesc')}</p>
            </div>
                ...
                >
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    <p className="text-xs text-text-muted mt-1">
                      {t('home.toolsCount', { count: cat.count })}
                    </p>
                  </div>
          ...
          <section className="page-container mt-20 sm:mt-24">
            <div className="flex items-center justify-between mb-8 animate-slide-up">
              {' '}
              <h2 className="section-heading">{t('home.popularConverters')}</h2>
              <Link
                to="/converter"
          ...
          <section
            ...
            style={{
              background:
                'linear-gradient(135deg, var(--color-accent-900), var(--color-accent-800))',
            }}
          >
            <div className="page-container">
              <div className="text-center mb-12 animate-slide-up">
                ...
                <p className="text-accent-200 mt-3 max-w-xl mx-auto">{t('home.whyDesc')}</p>
              </div>
