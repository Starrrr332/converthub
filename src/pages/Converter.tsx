      ...
      {fileListLength > 0 && (
        <div className="mt-8 space-y-6">
          ...
          <div
            ...
            onScroll={onScroll}
            style={{ height: fileListLength * ITEM_HEIGHT > containerHeight ? containerHeight : undefined }}
            className={fileListLength * ITEM_HEIGHT > containerHeight ? 'overflow-y-auto rounded-xl' : 'space-y-2'}
          >
