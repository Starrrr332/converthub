  ...
  const tools: Array<{ id: PdfTool; icon: React.ReactNode; label: string; description: string }> = [
    {
      ...
      label: t('pdf.tools.merge'),
      description: 'Unir varios PDF',
    },
    {
      id: 'split',
      icon: <Scissors className="w-5 h-5" />,
      label: t('pdf.tools.split'),
      description: 'Dividir PDF en partes',
    },
    {
      id: 'compress',
      icon: <Minimize2 className="w-5 h-5" />,
      label: t('pdf.tools.compress'),
      description: 'Reducir tamaño PDF',
    },
    {
      id: 'images-to-pdf',
      icon: <Image className="w-5 h-5" />,
      label: t('pdf.tools.imagesToPdf'),
      description: 'Convertir imágenes a PDF',
    },
    {
      id: 'rotate',
      icon: <RotateCw className="w-5 h-5" />,
      label: t('pdf.tools.rotate'),
      description: 'Rotar páginas PDF',
    },
    {
      id: 'watermark',
      icon: <Droplets className="w-5 h-5" />,
      label: t('pdf.tools.watermark'),
      description: 'Agregar marca de agua',
    },
    {
      id: 'page-numbers',
      icon: <Hash className="w-5 h-5" />,
      label: t('pdf.tools.pageNumbers'),
      description: 'Insertar números de página',
    },
    {
      id: 'protect',
      icon: <Lock className="w-5 h-5" />,
      label: t('pdf.tools.protect'),
      description: 'Proteger con contraseña',
    },
    {
      id: 'unlock',
      icon: <Unlock className="w-5 h-5" />,
      label: t('pdf.tools.unlock'),
      description: 'Quitar contraseña PDF',
    },
  ];
