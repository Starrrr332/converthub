  ...
  return (
    <div>
      ...
      <textarea
        ...
        placeholder="eyJhbGciOiJI...token..."
        className="w-full p-3 border-2 border-gray-200 rounded-lg h-24 font-mono text-sm mb-4"
      />
      <button
        onClick={decode}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div>
          ...
          <pre className="p-3 bg-gray-50 rounded-lg border-2 border-gray-200 overflow-auto max-h-48 text-xs">
            {header}
          </pre>
        </div>
        <div>
