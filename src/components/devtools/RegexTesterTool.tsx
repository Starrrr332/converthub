    ...
    <div>
      ...
      <div className="flex gap-2 mb-4">
        ...
        <input
          ...
          placeholder="flags"
          className="w-24 p-3 border-2 border-gray-200 rounded-lg font-mono"
        />
        <button
          onClick={test}
      ...
      <textarea
        ...
        className="w-full p-3 border-2 border-gray-200 rounded-lg h-48 font-mono text-sm mb-4"
      />
      {matches.length > 0 && (
        <div className="p-4 bg-green-50 rounded-lg">
          ...
          <div className="font-mono text-sm text-green-700 mt-1">
            {matches.map((m, i) => (
              <span key={i} className="inline-block bg-green-100 px-2 py-0.5 rounded mr-1 mb-1">
                {m}
              </span>
            ))}
          </div>
