...
const toolInfo = {
  image: {
    name: 'Canvas API',
    description: 'API nativa del navegador para procesamiento de imágenes. No requiere librerías externas.',
    features: [
  ...
  pdf: {
    ...
    privacy: 'Los archivos PDF se procesan completamente en tu navegador. No se suben a ningún servidor.',
    link: 'https://pdf-lib.js.org/'
  },
  spreadsheet: {
    name: 'SheetJS (xlsx)',
    description: 'La librería más popular para leer y escribir archivos de hojas de cálculo en JavaScript.',
    features: [
    ...
    privacy: 'Los archivos de hojas de cálculo se procesan localmente. Nunca se envían a servidores externos.',
    link: 'https://docs.sheetjs.com/'
  },
  audio: {
    name: 'FFmpeg.wasm',
    description: 'Puerto de WebAssembly de FFmpeg. El estándar de la industria para procesamiento de audio y video.',
    features: [
    ...
    privacy: 'El audio se procesa completamente en tu navegador usando WebAssembly. No se sube a ningún servidor.',
